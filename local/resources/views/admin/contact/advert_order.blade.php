            ...
            <div class="card-body">
              ...
              <table class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th class="hideResponsive768">Địa chỉ</th>
                  <th class="hideResponsive768">Số lượng</th>
                  <th>Chi tiêt</th>
                </tr>
                </thead>
                <tbody>
                	...
                	<tr>
	                  ...
	                  <td class="hideResponsive768">{{$item->address}}</td>
	                  <td class="hideResponsive768">{{$item->amount}}</td>
	                  <td>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="modal_item">
              <span class="modal_item_title">Địa chỉ:</span>
              <span class="modalAddress"></span>
            </div>
            <div class="modal_item">
              <span class="modal_item_title">Số Báo:</span>
              <span class="modalNo"></span>
            </div>
            <div class="modal_item">
              <span class="modal_item_title">Số Lượng:</span>
...
<!-- DataTables -->
<script type="text/javascript" src="js/advert_order.js"></script>
