...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <!-- left column -->
			<section class="col-md-9 col-sm-12 connectedSortable">
				<!-- TO DO List -->
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">
							<i class="ion ion-clipboard mr-1"></i>
							Danh sách bài emagazine
						</h3>
					</div>

					<!-- /.card-header -->
					<form method="post" action="{{ asset('admin/emagazine/sort') }}">
						{{csrf_field()}}
						<div class="card-body">
							<ul class="todo-list">
								@foreach($items as $item)
									<li>
										...
										<input style="width: 50px" type="text" value="{{$loop->index + 1}}"
											   name="items[{{$item->e_id}}]">
										<span class="text">{{$item->e_title}}</span>
									</li>
								@endforeach
							</ul>
						</div>
